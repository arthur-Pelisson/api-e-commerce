 ...
 */
final class Version20210428064604 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE order_items ADD CONSTRAINT order_items_ibfk_2 FOREIGN KEY (order_id) REFERENCES orders (products)');
